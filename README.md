# [PhenexBot](https://telegram.me/Meh737)
...
## Commands
PhenexBot has several commands that are only usable at certain ranks.
...
cd $HOME
git clone https://github.com/The-Demon12/PhenexBot.git
cd PhenexBot
chmod +x launch.sh
./launch.sh install
